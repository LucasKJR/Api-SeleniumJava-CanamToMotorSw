...
public class Canam {
	...
	public void Execute() {
		...
		List<Integer> CodigosDuplicados = new ArrayList();
																																												...
																																												/* LOGANDO>>>> */ driver.findElement(By.id("user_password")).sendKeys("12345678"); // LOGANDO
		...
		while (iteratorNomes.hasNext()) {
			...
			driver.findElement(By.xpath("//*[@id=\"new_part\"]/div[3]/div/div/div[1]")).click();
		...
		//	 this.esperar();
			driver.findElement(By.xpath("//*[@id=\"new_part\"]/div[4]/div/div/div[2]/div/div")).click();
